...
<table>
  ...
  <tr>
    <td><img src="illustrations/app_start.png" width="550"></td>
    <td><img src="illustrations/itinerary_result.png" width="550"></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="illustrations/map_result.png" width="550"></td>
    <td><img src="illustrations/final_result.png" width="550"></td>
  </tr>
</table>
...
To run this project locally, please follow these steps. (Note : You can use the train_project_colab_version.ipynb in colab, you just need to configure the correct path to tgvmax.db in your google drive)
